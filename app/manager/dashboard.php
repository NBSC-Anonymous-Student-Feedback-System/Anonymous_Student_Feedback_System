...
renderSidebar('manager','Dashboard');
?>
<div class="topbar">
...
<div class="content">
  <div class="page-header"><h1>Manager Dashboard</h1><p>Welcome, <?= sanitize($_SESSION['first_name']) ?>. Review and manage submitted feedback.</p></div>
  ...
  <div class="card">
    ...
    <div class="table-wrap">
      <table>
        <thead><tr><th>Category</th><th>Message</th><th>Priority</th><th>Submitted</th><th>Action</th></tr></thead>
        <tbody>
